<template>
  <section class="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-black py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300">
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-red-100/20 to-yellow-100/20 dark:from-red-900/10 dark:to-yellow-900/10"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div class="text-center lg:text-left space-y-6">
            ...
            <div class="w-24 h-1 bg-gradient-to-r from-red-500 to-yellow-500 mx-auto lg:mx-0 rounded-full"></div>
        ...
        <div class="flex justify-center lg:justify-end">
          <div class="relative group">
            ...
            <!-- Decorative elements -->
            <div class="absolute -top-4 -right-4 w-8 h-8 bg-yellow-500 dark:bg-yellow-400 rounded-full animate-pulse"></div>
            <div class="absolute -bottom-4 -left-4 w-6 h-6 bg-red-500 dark:bg-red-400 rounded-full animate-pulse delay-1000"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-red-500 via-yellow-400 to-red-500 dark:from-red-600 dark:via-yellow-500 dark:to-red-600"></div>
  </section>
</template>
